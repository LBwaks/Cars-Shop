...
from .import views
from .views import  CarUserView,CarCategoryView, cancel_approval,approve_bid,CarBids,CarsView,MyCarsView,add_vehicle,AddVehicleView,AddVehicleImagesView,add_vehicle_image,CarDetailView,DeleteVehicleView,EditVehicleView,AddFavouriteView,FavouritesView, approve_bid
...
urlpatterns = [
    ...
    path('category/<slug>/',CarCategoryView.as_view(),name='category'),
    path('user/<username>/',CarUserView.as_view(),name='user_cars')
]
